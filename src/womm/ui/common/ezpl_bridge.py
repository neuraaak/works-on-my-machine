...
# Third-party imports
from ezpl import EzLogger, Ezpl, EzPrinter, LogLevel, RichWizard
...
class ExtendedPrinter(EzPrinter):
    ...
    ) -> Generator[tuple[Progress, int, str]]:
        """
    ...
    ) -> Generator[tuple[Progress, int, str, str]]:
        """
    ...
    def create_step_progress(
        ...
        show_time: bool = True,
    ) -> Generator[tuple[Progress, int, list[str]]]:
        """
    ...
    ) -> Generator[tuple[Progress, int, str, int]]:
        """
    ...
    def create_layered_progressbar(
        ...
        show_time: bool = True,
    ) -> Generator[tuple[Progress, dict[str, Any]]]:
        """
...
class EzplBridge:
    ...
    def printer(self) -> ExtendedPrinter:
        ...
        return cast(ExtendedPrinter, self._ezpl._printer)
...
ezprinter: ExtendedPrinter = cast(ExtendedPrinter, _ezpl_instance._printer)
