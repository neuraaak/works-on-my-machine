...
from ..ui.console import console, print_error, print_header, print_success, print_system
...
class SystemManager:
    ...
    def check_prerequisites(self, tools: List[str]) -> None:
        ...
        from ..ui.console import print_system
    ...
    def install_prerequisites(
        ...
        for runtime in selected_runtimes:
            ...
            with create_spinner_with_status(f"Installing {runtime}...") as (
                ...
                if ask_path:
                    from ..ui.console import print_warn
                    from ..ui.prompts import prompt_path
