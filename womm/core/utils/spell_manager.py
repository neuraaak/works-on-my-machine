...
class SpellManager:
    ...
    def cspell_available(self) -> bool:
        ...
        from ..tools.cspell_utils import check_cspell_installed
    ...
    def perform_setup_project(
        ...
        try:
            with create_spinner_with_status("Setting up CSpell configuration...") as (
                ...
                if not project_type:
                    from ..tools.cspell_utils import detect_project_type
                ...
                from ..tools.cspell_utils import setup_project_cspell
    ...
    def display_project_status(
        ...
        try:
            with create_spinner_with_status("Analyzing project...") as (progress, task):
                ...
                from ..tools.cspell_utils import get_project_status
    ...
    def add_words(
        ...
        try:
            with create_spinner_with_status("Adding words to configuration...") as (
                ...
                from ..tools.cspell_utils import add_words_to_config
    ...
    def perform_add_all_dictionaries(
        ...
        try:
            ...
            from ..tools.dictionary_manager import get_dictionary_info
    ...
    def perform_spell_check(
        ...
        try:
            with create_spinner_with_status("Running spell check...") as (
                ...
                # Use cspell_utils for the actual operation
                from ..tools.cspell_utils import run_spellcheck
                ...
                if spell_results["success"]:
                    ...
                    if issues:
                        ...
                        table.add_column(
                            "Issues", style="yellow", justify="center", width=10
                        )
                        ...
                        for file_path, file_issues_list in files_issues.items():
                            ...
                            table.add_row(
                                str(file_path), str(len(file_issues_list)), sample_text
                            )
