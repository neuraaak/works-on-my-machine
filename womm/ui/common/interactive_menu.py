...
class InteractiveMenu:
    ...
    def select_from_list(
        ...
        Args:
            ...
            _default_index: Default selected index (ignored with InquirerPy)
            _width: Menu width (ignored with InquirerPy)
    ...
    def select_multiple_from_list(
        ...
        items: list[dict[str, Any]],
        display_func: Callable[[dict[str, Any]], str] | None = None,
        _checked_items: list[str] | None = None,
        ...
        Args:
            items: List of items to display
            display_func: Function to format each item for display
            _checked_items: (unused) kept for API parity
...
__all__ = ["InteractiveMenu", "format_backup_item"]
