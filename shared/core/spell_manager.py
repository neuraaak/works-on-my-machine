...
class SpellManager:
    ...
    def check_spelling(self, path: Path, fix_mode: bool = False) -> SpellSummary:
        ...
        try:
            ...
            # Parse CSpell output
            summary = self._parse_cspell_output(result, path)
    ...
    def _parse_cspell_output(self, result, path: Path) -> SpellSummary:
